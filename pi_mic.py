...
class TLV320ADC:
    ...
    def set_polarity_inverted(self):
        self.i2cwrite("ADCX140_PDM_CFG",0b00001111)

        return

    def set_config(self):
        # Set GPI1-4 as PDM mic inputs
        self.i2cwrite("ADCX140_CH1_CFG0",0b01000000)
        self.i2cwrite("ADCX140_CH2_CFG0",0b01000000)
        self.i2cwrite("ADCX140_CH3_CFG0",0b01000000)
        self.i2cwrite("ADCX140_CH4_CFG0",0b01000000)

        # Set GPO1-4 as PDM clock ouptuts for microphones
        self.i2cwrite("ADCX140_GPO_CFG0",0b01000001)
        self.i2cwrite("ADCX140_GPO_CFG1",0b01000001)
        self.i2cwrite("ADCX140_GPO_CFG2",0b01000001)
        self.i2cwrite("ADCX140_GPO_CFG3",0b01000001)

        # Set GPI1-4 as PDM data inputs from microphones
        self.i2cwrite("ADCX140_GPI_CFG0",0b01000101) # GPI1 - Ch1 and Ch2, GPI2 - Ch3 and Ch4
        self.i2cwrite("ADCX140_GPI_CFG1",0b01100111) # GPI3 - Ch5 and Ch6, GPI4 - Ch7 and Ch8

        # Enable all intputs and outputs(TODO: narrow down to actual) 
        self.i2cwrite("ADCX140_IN_CH_EN",0b11111111)
        self.i2cwrite("ADCX140_ASI_OUT_CH_EN",0b11111111)

        # Enable ADC
        self.i2cwrite("ADCX140_PWR_CFG",0b01100000)
        return
    def set_gain_max(self):
        self.i2cwrite("ADCX140_CH1_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH2_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH3_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH4_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH5_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH6_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH7_CFG2",0b11111111)
        self.i2cwrite("ADCX140_CH8_CFG2",0b11111111)
...
def initialize():
    ...
    # adc.set_gain_max() # - uncomment this if you want 27dB extra volume on all channels
    adc.set_config()
